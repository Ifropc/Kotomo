...
public class Column implements HasRectangle {
	 ...
	 */
	private io.github.ifropc.kotomo.Column simpleColumn = null;
	
	/**
	 * Simplified Column representation intended for API users.
	 */
	public io.github.ifropc.kotomo.Column getSimpleColumn() {
		
		if (simpleColumn != null) {
			return simpleColumn;
		}
		
		simpleColumn = new io.github.ifropc.kotomo.Column();
